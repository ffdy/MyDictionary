...
@Database(entities = [TranSearchDb::class], version = 1)
@TypeConverters(Converters::class)
abstract class TranSearchDbDatabase:RoomDatabase() {
    ...
    companion object {
        ...
        @Volatile private var instance: TranSearchDbDatabase? = null

        fun getInstance(context: MainActivity): TranSearchDbDatabase {
        ...
        private fun buildDatabase(context: Context): TranSearchDbDatabase {
            val DATABASE_NAME = "todo.db"
            return Room.databaseBuilder(context, TranSearchDbDatabase::class.java, DATABASE_NAME)
//                .addCallback(
